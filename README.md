...
**#2 Match between system and the real world**: The website/app uses language that the average user would understand. | **Good**: The Website (both Mobile and Desktop) use simple terminology in the home screen and throughout the Website in order to make it easy for users to navigate and find what they want. E.g. (Lessons, Exercises, Tools, Products, News, Contact) | **Improvement**: No Improvements as of now the website with it's current offerings does an excellent job matching between system and the real world. | N/A
